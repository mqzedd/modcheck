...
# main_dir = input('Minecraft Directory: ') + '/mods'
main_dir = "C:/Users/210284/Downloads/mods"
...
print(str(len(mod_renamed)) + " mods were found that did not match with modrinth names")
